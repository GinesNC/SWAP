...
*La ejecución de **apache2 -v** muestra lo siguiente:*
Ambas máquinas tienen la misma versión. [apache.txt](https://github.com/GinesNC/SWAP/blob/master/practica1/archivos/apache.txt)
